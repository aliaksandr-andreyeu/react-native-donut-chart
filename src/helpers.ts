...
export const validateSlices = (slices: DonutChartSlice[]): void => {
...
export const modifySlices = (
  ...
  const sortFunc = (a: DonutChartSlice, b: DonutChartSlice): number => {
    switch (sort) {
      case true:
 ...
 */
export const normalizeSlices = (slices: InternalDonutSlice[]): InternalDonutSlice[] => {
...
export const createDonutSlices = (data: InternalDonutSlice[]): DonutChartData[] => {
